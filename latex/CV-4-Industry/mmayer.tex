...
\cvevent{Data Scientist Intern}{Orange Labs}{March 2017 -- September 2017}     {Nice, France}
\textbf{Java} \textbf{recommendation system} based on \textbf{RDF triplet data} in addition to \textbf{NLP} methods using \textbf{TF-IDF} and \textbf{Word2Vec} 
