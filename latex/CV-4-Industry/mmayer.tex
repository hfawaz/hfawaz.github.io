...
\cvevent{Senior Machine Learning Engineer}{Ericsson}{May 2022 -- Present}     {Paris, France}
% {Machine Learning for wireless telecommunication.}\\
\begin{itemize}
    \item \textbf{Tech Lead} for in-house research project on \textbf{transfer learning}
    \vspace{0.3em}
    \begin{itemize}
    	\item[-] Setup \textbf{best practices} for machine learning experimentation
        \item[-] Code review \& \textbf{mentoring} of PhD students \& data scientists
        \item[-] Implement state of the art models for domain adaptation
    ...
    \begin{itemize}
        ...
        \item[-] Code review, unit \& integration tests, CI/CD
        \item[-] Dealing with \textbf{Kafka} based communication system 
        \item[-] Working and \textbf{collaborating} with other \textbf{microservices}
...
\begin{itemize}
    ...
    \vspace{0.5em}
    \begin{itemize}
        \item[-] Benchmark latest \textbf{Computer Vision} deep learning models
        ...
        \item[-] \textbf{Monitor} model performance and decay (e.g. accuracy)
...
\cvevent{Software Developer Intern}{Orange Labs}{March 2017 -- September 2017}     {Nice, France}
